...
const sections: GuideSection[] = [
  ...
  },
  {
    ...
    howTo: [
      ...
      "For a local delivery, take or choose a JPEG, PNG, WebP or HEIC photo under 4 MiB on the phone page and tap Store photo privately. Wait for the stored confirmation. If the connection fails, keep the same photo and retry; the page keeps that upload attempt. If it says the attempt can no longer be retried, tap Store photo privately again with the same photo; the page starts a new attempt. A pending upload is not proof of delivery. The photo is optional until Peter approves the exception policy.",
