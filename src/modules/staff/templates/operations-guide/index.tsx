...
const sections: GuideSection[] = [
  ...
  },
  {
    ...
    howTo: [
      ...
      "The new calendar starts switched off. Until the office approves activation, checkout keeps the existing scheduling controls and staff can enter the agreed date after creating a draft. Switching it on requires approved operating data; a calendar outage after activation does not reopen manual scheduling. In Strapi Checkout, the operating owner must approve and publish the Fulfillment Calendar Policy, with coverage dates, Eastern cutoffs, preparation times and pickup windows. Historical cutoffs are not an approval for a new calendar.",
