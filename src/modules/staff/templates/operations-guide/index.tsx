...
const sections: GuideSection[] = [
  ...
  },
  {
    ...
    watch: [
      "Calendar source changes are read again when a date is selected and when an order is submitted. Missing, expired or incomplete operating data stops date selection; it never activates a generic schedule.",
      ...
      "The customer chooses an arrival or pickup date; the backend separately records the plant pick date and dispatch date. QuickBooks Due Date is the dispatch date. Accepted orders keep their original promise; a later route cancellation needs staff exception handling and customer contact.",
      "Release gate: staff phone-order preparation and shipping-override screens must adopt the same calendar before this candidate deploys. Their existing free-form date fields cannot substitute for an accepted calendar selection.",
