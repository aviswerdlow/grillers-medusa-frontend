...
const sections: GuideSection[] = [
  ...
  },
  {
    ...
    howTo: [
      ...
      "Southeast pickup uses Strapi pickup locations with available dates and cutoff days. Eligibility is state-wide: a Tennessee address can choose any active Tennessee stop, while a Texas address is shown Dallas Consolidated Shipping.",
      ...
      "In Strapi's cold-chain settings, the reviewed packing policy names the box dimensions, empty-box weight, gross-weight limit, box-space capacity and its calibration, and dry ice by transit time. Publish a new policy version only after Peter approves the rules. Missing or incompatible rules stop carrier quotes for review.",
