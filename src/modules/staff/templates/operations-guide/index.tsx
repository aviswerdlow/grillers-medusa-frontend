...
const sections: GuideSection[] = [
  ...
  },
  {
    ...
    watch: [
      ...
      "Allow up to five minutes for a newly published cold-chain setting to reach the quote service. Verify the published version and affected service before promising availability. Publishing Enabled = false withdraws carrier quotes after the cache refresh; it does not cancel accepted orders.",
