...
const sections: GuideSection[] = [
  ...
  },
  {
    ...
    howTo: [
      ...
      "For Send customer checkout link, prepare the checkout link and email it to the customer for review and payment. The customer may choose the optional order-text box themselves when they complete checkout.",
    ],
    watch: [
