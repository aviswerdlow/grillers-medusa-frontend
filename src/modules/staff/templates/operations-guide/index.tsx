...
const sections: GuideSection[] = [
  ...
  },
  {
    ...
    howTo: [
      ...
      "The launch candidate adds Review your order in the payment step. Compare the address, arrival or pickup date, receipt email, quantities, fixed or per-pound pricing, shipping and estimate. Use its edit links before placing the order; changed or expired details require a fresh review.",
      "An invoice account must have its own approved payment terms. Missing terms need an office correction; checkout does not assume Net 10.",
      ...
      "If placement is uncertain, use Check order status for the same cart. For a confirmed phone payment with failed order confirmation, use Retry order confirmation. Do not collect a second payment.",
    ...
    watch: [
      ...
      "Native Admin draft conversion is disabled in this candidate because it lacks the accepted review. Create an order through customer or staff checkout.",
