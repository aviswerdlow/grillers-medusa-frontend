...
const sections: GuideSection[] = [
  ...
  },
  {
    ...
    title: "Pay by invoice release gate",
    summary:
      "Institutional pay-by-invoice is behind GP_INSTITUTIONAL_TERMS_ENABLED and stays off until the QuickBooks source, credit, finalization, collections, and rehearsal gates are approved. Retail checkout stays card-first.",
    useFor: [
      "Checking why an institutional account cannot currently choose invoice terms.",
      "Reviewing a held account or order with the named credit approver.",
      "Separating accepted order, open invoice, pending collection, and confirmed QuickBooks reconciliation.",
    ],
    howTo: [
    ...
    watch: [
      ...
      "A green Web Connector session does not prove that a specific invoice or collection was applied.",
      "Peter's account rules and the named override capability must be recorded before institutional terms are enabled.",
    ],
  },
  {
    id: "order-lifecycle",
