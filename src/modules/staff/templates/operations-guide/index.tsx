...
const sections: GuideSection[] = [
  ...
  },
  {
    ...
    howTo: [
      ...
      "In Strapi cold-chain settings, save a draft of the seasonal packing policy with its approval, revision and effective dates. Record elapsed-hour ice rules, a delay allowance, permitted services and boxes, and maximum exposure and gross weight. The dates must cover packing through arrival plus the delay allowance. Carrier business days stay separate. Publish only after Peter approves the values; incomplete or conflicting rules cannot be published.",
      ...
      "Each box needs measured dimensions and empty-box weight, a gross-weight limit, total usable space, and the reviewed space consumed per pound of dry ice. The same capacity calibration must be used for items and boxes. More ice can require another box or make a service unavailable. Ice price changes cost; they do not change the pounds of ice.",
